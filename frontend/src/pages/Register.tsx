...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-3 sm:px-4 py-6 sm:py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-5 sm:mb-8">
          ...
          <p className="text-muted text-xs sm:text-sm mt-2">Crie sua conta</p>
        </div>
